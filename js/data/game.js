const game = {
    ...
    achievements: [
        new Achievement("You played José Layers!", "If you dont have this, you shouldn't exist", "J", () => true),
        new Achievement("José Coins", "Start gaining Jose Coins", "JC", () => game.alephLayer.isUnlocked()),
        new Achievement("Jose-Stacking up", "Do a Jose-stack and restart your progress", "<img alt=\"LC\" class=\"inline\" src=\"images/layercoin.svg\"/>", () => game.restackLayer.timesReset > 0),
        new Achievement("No turning back", "Go meta and be reborn", "&Omega;", () => game.metaLayer.active),
        new Achievement("Here i come! psi!", "Reach layer 1.8e308 and finish "+mod.primaryName+mod.secondaryName, "ψ", () => game.metaLayer.layer.gte(Infinities[0])),
    ],
    secretAchievements: [
    ],
